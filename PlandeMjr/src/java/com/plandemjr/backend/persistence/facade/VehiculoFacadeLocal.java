...
public interface VehiculoFacadeLocal {
    ...
    List<Vehiculo> marcaReciente(int lanzamiento);
    
    List<Vehiculo> precioAlto(int precio);
    
    List<Vehiculo> precioBajo(int precio);
    
    //List<Vehiculo> masVendido(int vehiculo);
